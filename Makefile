...
$(EXECUTABLE_FNAME)	:	compile
	...
	$(NDSTOOL)	-c 	${@:.nds=.srl} -g "TGDS" "NN" "NDS.TinyFB" -b	icon.bmp "ToolchainGenericDS SDK;$(TGDSPROJECTNAME) TWL Binary;" -7 arm7/arm7-nonstripped_dsi.elf -9 $(CURDIR)/arm9/arm9_twl.bin -e9  0x02000000
	-mv ${@:.nds=.srl}	/E
