...
{
	if(RVbufL1) safeFree(RVbufL1);
	if(RVbufL2) safeFree(RVbufL2);
	if(RVbufL3) safeFree(RVbufL3);
	if(RVbufL4) safeFree(RVbufL4);
	if(RVbufL5) safeFree(RVbufL5);
	if(RVbufL6) safeFree(RVbufL6);
	if(RVbufL7) safeFree(RVbufL7);
	if(RVbufL8) safeFree(RVbufL8);
	if(RVbufR1) safeFree(RVbufR1);
	if(RVbufR2) safeFree(RVbufR2);
	if(RVbufR3) safeFree(RVbufR3);
	if(RVbufR4) safeFree(RVbufR4);
	if(RVbufR5) safeFree(RVbufR5);
	if(RVbufR6) safeFree(RVbufR6);
	if(RVbufR7) safeFree(RVbufR7);
	if(RVbufR8) safeFree(RVbufR8);
