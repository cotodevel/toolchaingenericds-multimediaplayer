...
#include <stdlib.h>                                      /* safeMalloc(), safeFree() */
...
void *drms_alloc( char *psz_homedir )
{
    ...
    p_drms = safeMalloc( sizeof(struct drms_s) );
...
/*****************************************************************************
 * drms_free: safeFree a previously allocated DRMS structure
 *****************************************************************************/
