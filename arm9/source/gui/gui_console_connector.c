...
vramSetup * getProjectSpecificVRAMSetup(){
	return TGDSVIDEOPLAYER_2DVRAM_SETUP();
}
...
__attribute__ ((optnone))
#endif
vramSetup * TGDSVIDEOPLAYER_2DVRAM_SETUP(){
	...
	vramSetupInst->vramBankSetupInst[VRAM_D_INDEX].vrambankCR = VRAM_D_0x06000000_ARM7;	//ARM7 128K @ 0x06000000 (Sound streaming ARM7 direct ima adpcm)
